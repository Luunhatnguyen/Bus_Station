...
<!--        <link rel="stylesheet" href="<spring:url value="/resources/vendor/bootstrap/css/bootstrap.min.css" />" >-->
    ...
    <body>
        ...
        <!-- HEADER -->
        <tiles:insertAttribute name="carrier_header"/>

        <!-- SIDEBAR -->
        <tiles:insertAttribute name="carrier_sidebar"/>

        <!-- page content -->



        <tiles:insertAttribute name="carrier_content"/>


        <!-- FOOTER -->
        <tiles:insertAttribute name="carrier_footer"/>
